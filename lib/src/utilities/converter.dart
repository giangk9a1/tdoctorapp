...
class ConvertUtility {
  static final DateFormat _displayDayMonthFormat = DateFormat('dd/MM');
  ...
  static final DateFormat _displayddMMMMYYYY = DateFormat('dd MMMM', 'vi_VN');
  static final DateFormat _dayDateFormat = DateFormat('EEEE, dd MMM', 'vi_VN');
  ...
  static String formatDisplayDayMonth(DateTime? date) {
    if (date == null) return '';
    return _displayDayMonthFormat.format(date);
  }
